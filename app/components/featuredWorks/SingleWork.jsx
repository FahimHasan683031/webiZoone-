...
const SingleWork = ({ project, index }) => {
  ...
  return (
    <div
      className={`relative w-full p-5 md:p-0 flex flex-col justify-center items-center lg:justify-normal lg:items-start ${
        index % 2 !== 0 ? "lg:-mt-20" : ""
      }`}
    >
      <ScrollAnimation
        ...
        position="y"
      >
        <div ref={containerRef} className="project w-fit overflow-hidden">
          <Image
            src={project?.image}
            alt={project?.title}
            width={500}
        ...
        <div className="absolute bottom-6 md:bottom-12 md:-right-5 md:text-right text-center w-full">
          <div className=" overflow-hidden">
            <ScrollAnimation
              ...
              position="y"
            >
              <h2 className="text-3xl font-bold md:tracking-wider tracking-wide">
                {project?.title}
              </h2>
