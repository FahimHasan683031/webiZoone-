...
const AnimatedButton = ({ text, link, textColor, font, textSize , borderColor}) => {
    return (
        <div className='relative group inline-block overflow-hidden'>
            ...
            <div className={`w-full  absolute bottom-0 left-0 border-b border-1  ${borderColor ? borderColor : "border-orange-600"} hover:transition duration-1000 transform group-hover:w-full group-hover:translate-x-full`}></div>
        </div>
    );
};
